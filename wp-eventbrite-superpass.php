...
if (!class_exists('WP_Eventbrite_Superpass')) :
    ...
    final class WP_Eventbrite_Superpass
    {
        ...
        private function includes()
        {
            ...
            require_once ESP_PLUGIN_DIR . 'includes/shortcodes.php';
        }
        ...
        public function get_super_passes()
        {
            if (!defined('ESP_SEARCHED_SUPERPASSES')) {
                ...
                foreach ($results as $result) {
                    ...
                    $super_pass = new ESP_Super_Pass($values['ESP_SUPER_PASS_COST'][0], $result->post_title, $values['ESP_SUPER_PASS_EVENT'][0], $result->ID);
                    if (isset($values['ESP_SUPER_PASS_ADDON'])) {
                        $events = explode(',', $values['ESP_SUPER_PASS_ADDON'][0]);
